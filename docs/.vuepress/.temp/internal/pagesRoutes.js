...
const routeItems = [
  ["v-8daa1a0e","/",{"title":"博客主页","icon":"home","type":"home","readingTime":{"minutes":0.18,"words":53},"excerpt":"这是一个博客主页的案例。 要使用此布局，你应该在页面前端设置 layout: Blog 和 home: true。 相关配置文档请见 博客主页。"},["/index.html","/README.md"]],
  ...
  ["v-fffb8e28","/guide/",{"title":"主要功能与配置演示","icon":"creative","type":"article","readingTime":{"minutes":0.07,"words":21},"excerpt":"目录 Markdown 展示; 页面展示; 禁用展示; 加密展示;","category":["使用指南"]},["/guide/index.html","/guide/README.md"]],
  ...
  ["v-0978b044","/guide/markdown.html",{"title":"Markdown 展示","icon":"markdown","type":"article","readingTime":{"minutes":3.97,"words":1191},"excerpt":"<p>VuePress 主要从 Markdown 文件生成页面。因此，你可以使用它轻松生成文档或博客站点。</p>\n<p>你应该创建和编写 Markdown 文件，以便 VuePress 可以根据文件结构将它们转换为不同的页面。</p>\n","category":["使用指南"],"tag":["Markdown"]},["/guide/markdown","/guide/markdown.md"]],
